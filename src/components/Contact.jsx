...
const Contact = () => {
    ...
    return (
        <>
            <div name="Contact" className='max-w-screen-2xl container mx-auto px-4 my-20 md:px-20'>
                ...
                <div className='flex flex-col items-center justify-center mt-5'>
                    <form onSubmit={handleSubmit(onSubmit)} className='bg-slate-200 w-96 px-8 py-6 rounded-xl'>
                        ...
                        <button type='submit' className='bg-black text-white rounded-xl px-3 py-2 hover:bg-slate-900 duration-300'>Send</button>
                    </form>
                </div>
            </div>
        </>
